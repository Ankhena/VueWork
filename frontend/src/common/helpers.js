...
// Напишем функцию, которая будет принимать строку с метками и разделять её на массив по определённому идентификатору:
...
// Для нормализации задач напишем функцию:
