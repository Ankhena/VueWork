<template>
  <main class="content">
    <section class="desk">
      ...
      <!-- Колонки и задачи-->
      <!-- Если на доске есть колонки, нужно их отобразить. Если нет — показать, что        доска пуста. -->
      ...
      <!-- Пустая доска -->
      <!-- Если колонок нет, нужно показать соответствующее сообщение. -->
...
// Сделаем нормализацию задач:
const normalizedTasks = rawTasks.map((task) => normalizeTask(task));

// Функция для сортировки задач по колонкам:
